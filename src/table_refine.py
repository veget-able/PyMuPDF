...
refine_grid_structure / refine_grid_rows API and the _refine_* / _split_*
helpers that refine a detected table's cell grid using page text and
vector-graphics geometry. Re-exported by pymupdf.table; never runs on the
default find_tables() path. This module has no table.py dependency.
"""
